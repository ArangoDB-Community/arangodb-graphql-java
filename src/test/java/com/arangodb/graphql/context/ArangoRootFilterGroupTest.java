...
public class ArangoRootFilterGroupTest {

    @Test
    public void testDepth(){
        Map<String, Object> args = new LinkedHashMap<>();
        ArangoRootFilterGroup arangoRootFilterGroup = new ArangoRootFilterGroup(args, null);
        assertThat(arangoRootFilterGroup.getDepth(), equalTo(-1));
    }
